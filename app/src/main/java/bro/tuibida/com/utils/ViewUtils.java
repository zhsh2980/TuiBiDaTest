...
import static bro.tuibida.com.utils.UIUtils.getAppContext;
...
public class ViewUtils {
    ...
    public static int getScreenWidth() {
        return UIUtils.getScreenWidth(getAppContext());
    }

    public static int getScreenHeight() {
        return UIUtils.getScreenHeight(getAppContext());
    }
...
//            }
    ...
    public static void setTvFonts(TextView textView) {
        if (typeFace == null) {
            typeFace = Typeface.createFromAsset(getAppContext().getResources().getAssets(), "fonts/AvenirNextLTPro-BoldCn.otf");
        }
    ...
    public static void setScrollViewShadow(final ScrollView scrollView, final View vShadow) {
    ...
    public static void openSysAppPushPage(Activity activity) {
        if (!activity.isFinishing()) {
            ...
            if (Build.VERSION.SDK_INT >= 9) {
                ...
                localIntent.setData(Uri.fromParts("package", getAppContext().getPackageName(), null));
